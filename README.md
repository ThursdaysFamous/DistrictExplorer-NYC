...
> **Status: porting in progress.** This is the New York City fork of [District Explorer](https://github.com/ThursdaysFamous/DistrictExplorer-CHI) (Chicago is the reference implementation). It is being built thread by thread following [`METRO_EXPANSION_PLAYBOOK.md`](METRO_EXPANSION_PLAYBOOK.md). **Threads 0–3 are complete** — **16 of 24 layers** live: the metro-agnostic engine on an NYC map (NYC bounds, palette, branding, keyless [NYC Planning GeoSearch](https://geosearch.planninglabs.nyc) geocoder); **Geography** — Borough/County, Neighborhood (NTA), ZIP (MODZCTA); **Political** — NY Supreme Court Judicial District, Civil Court District; **Public Safety** — NYPD Precinct (+ Sector sub-layer), Police Station & Firehouse (nearest-3), FDNY Battalion; **Schools** — Elementary/Middle/High School Zone (with honest choice-based empty states), Community School District, Community Education Council, and School sites (nearest-3, public/charter/private). The remaining layers land in Threads 4–6.
